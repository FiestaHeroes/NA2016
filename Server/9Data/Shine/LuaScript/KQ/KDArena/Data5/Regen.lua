...
RegenInfo =
{
	Monster =
	{
		...
		{
			-- 원거리
			{ Index = "Arena100_M",	X = 2970, Y = 3200, Dir = 0, RegenInterval = 20 },
			{ Index = "Arena100_M",	X = 3430, Y = 3200, Dir = 0, RegenInterval = 20 },

			-- 근거리
			{ Index = "Arena100_C",	X = 3200, Y = 2970, Dir = 0, RegenInterval = 20 },
			{ Index = "Arena100_C",	X = 3200, Y = 3430, Dir = 0, RegenInterval = 20 },
		}
	},
