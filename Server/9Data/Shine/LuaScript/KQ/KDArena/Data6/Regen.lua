...
RegenInfo =
{
	Monster =
	{
		...
		{
			-- 원거리
			{ Index = "Arena110_M",	X = 2970, Y = 3200, Dir = 0, RegenInterval = 20 },
			{ Index = "Arena110_M",	X = 3430, Y = 3200, Dir = 0, RegenInterval = 20 },

			-- 근거리
			{ Index = "Arena110_C",	X = 3200, Y = 2970, Dir = 0, RegenInterval = 20 },
			{ Index = "Arena110_C",	X = 3200, Y = 3430, Dir = 0, RegenInterval = 20 },
		}
	},
	...
	NPC	=
	{
		...
		ArenaGate	=	{
							...
							{ Index = "ArenaGate_R", X = 5070,	Y = 3970, Dir = 0, },
