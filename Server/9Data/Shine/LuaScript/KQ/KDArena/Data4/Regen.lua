...
RegenInfo =
{
	Monster =
	{
		...
		{
			-- 원거리
			{ Index = "Arena90_M",	X = 2970, Y = 3200, Dir = 0, RegenInterval = 20 },
			{ Index = "Arena90_M",	X = 3430, Y = 3200, Dir = 0, RegenInterval = 20 },

			-- 근거리
			{ Index = "Arena90_C",	X = 3550, Y = 3200, Dir = 0, RegenInterval = 20 },
			{ Index = "Arena90_C",	X = 2840, Y = 3200, Dir = 0, RegenInterval = 20 },
		}
	},
