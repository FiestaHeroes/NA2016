...
RegenInfo =
{
	Monster =
	{
		...
		{
			-- 원거리
			{ Index = "Arena80_A",	X = 2970, Y = 3200, Dir = 0, RegenInterval = 20 },
			{ Index = "Arena80_A",	X = 3430, Y = 3200, Dir = 0, RegenInterval = 20 },
			
			-- 근거리
			{ Index = "Arena80_F",	X = 3200, Y = 2970, Dir = 0, RegenInterval = 20 },
			{ Index = "Arena80_F",	X = 3200, Y = 3430, Dir = 0, RegenInterval = 20 },			
		}
	},
