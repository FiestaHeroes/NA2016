...
{
	{
		DOOR_INDEX 		= "WarL_Door1",
		DOOR_BLOCK		= "Door01",
		REGEN_POSITION 	= { X = 6331, Y = 6993, DIR = 90 }
	},
	{
		DOOR_INDEX 		= "WarL_Door2",
		DOOR_BLOCK		= "Door02",
...
EVNET_DATA_NO4 =
{
	...
	PFORAS =
	{
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11523, Y = 6977, DIR = 256  } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11619, Y = 6977, DIR = 256  } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11707, Y = 6977, DIR = 256  } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11479, Y = 7215, DIR = 256  } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11562, Y = 7255, DIR = 256  } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11659, Y = 7292, DIR = 256  } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11368, Y = 7440, DIR = 256  } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11431, Y = 7494, DIR = 256  } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11506, Y = 7554, DIR = 256  } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11489, Y = 6734, DIR = 289 } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11566, Y = 6708, DIR = 289 } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11655, Y = 6668, DIR = 289 } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11368, Y = 6528, DIR = 289 } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11441, Y = 6474, DIR = 289 } },
		{ MOBINDEX = "WarL_PForas", REGENPOSITION = { X = 11514, Y = 6421, DIR = 289 } },
	}
}
