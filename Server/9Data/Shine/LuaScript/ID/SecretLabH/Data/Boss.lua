...
BossSkill =
{
	...
	PeriodicSummonHP_Boss1 	=
	{
		HP500 =
		{
			SummonMobs =
			{
				{ Index = "LabH_Ghost02", 	CountPerSummon = 2,	SummonCount = 0, Interval = 180 },
			},
		},
	},
	...
	PeriodicSummonHP_Boss2 	=
	{
		...
		HP250 =
		{
			SummonMobs =
			{
				{ Index = "LabH_Snake_In", 	CountPerSummon = 2,	SummonCount = 0, Interval = 180 },
			},
		},
	},
}
