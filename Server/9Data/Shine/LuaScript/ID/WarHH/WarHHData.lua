...
EVNET_DATA_NO3 =
{
	...
	SFOCALOR 	= { MOBINDEX = "WarHH_IFocalor", REGEN_POSITION = { X = 12632, Y = 12552, DIR = 270 } },

	SRANGE 		=
	{
		MOBINDEX = "WarHH_IRange",
		REGEN_POSITION =
		{
...
EVNET_DATA_NO4 =
{
	...
	SFOCALOR 	= { MOBINDEX = "WarHH_FFocalor", REGEN_POSITION = { X = 16817, Y = 12553, DIR = 270} },
	SRANGE 		=
	{
		MOBINDEX = "WarHH_FRange",
		REGEN_POSITION =
		{
...
EVNET_DATA_NO5 =
{
	...
	FAVANAS_GATE =
	{
		...
		REGEN_MONSTER 	=
		{
			{ MOBINDEX = "WarHH_FDevildom", 	REGEN_TIME = 18 },
			{ MOBINDEX = "WarHH_TDevildom", 	REGEN_TIME = 18 },
			{ MOBINDEX = "WarHH_FDevildom", 	REGEN_TIME = 18 },
		}
	}
}
