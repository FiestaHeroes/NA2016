...
LeviathanSkillInfo =
{
	...
	Routine_Leviathan =
	{
		...
		{
			RegenTick 		= 120,
			RegenMob		= { Index = "LevH_ID_NestGuardianEgg", Num = 2, },
			RegenMaxCount	= 100,
		},
		...
		{
			RegenTick 		= 120,
			RegenMob		= { Index = "LevH_ID_NestGuardEgg", Num = 2, },
			RegenMaxCount	= 100,
		},
		...
		{
			RegenTick 		= 120,
			RegenMob		= { Index = "LevH_ID_NestBuffEgg", Num = 2, },
			RegenMaxCount	= 100,
		},
	...
	{
		EggBrakeTime 	= 60,
		Summon = { Index = "LevH_ID_NestGuardian", Num = 2, },
	},

	Routine_GuardEgg =
	{
		EggBrakeTime 	= 60,
		Summon = { Index = "LevH_ID_NestGuard", Num = 15, },
	},
	...
	Vanish_WhenLeviDead =
	{
		"LevH_ID_NestGuardianEgg", "LevH_ID_NestGuardEgg", "LevH_ID_NestBuffEgg",
		"LevH_ID_NestGuardian", "LevH_ID_NestGuard",
	}
